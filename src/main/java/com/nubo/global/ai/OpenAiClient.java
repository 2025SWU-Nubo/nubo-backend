...
public class OpenAiClient {
  ...
  private String buildPrompt(String inputText) {
    return String.format("""
      ...
      - Unordered list: `-` 사용, 각 하위 리스트는 레벨당 공백 3칸 들여쓰기로 작성한다.
      - Ordered list: 항상 `1.` 으로 표기하며, 각 하위 리스트는 레벨당 공백 3칸 들여쓰기로 작성한다.
      - Bold: `**굵게**` 표현 허용
      - 문단(heading/문장) 사이에는 빈 줄 한 줄(`\\n\\n`)을 넣어 구분한다.
      - 리스트 내부 항목들 사이에는 빈 줄을 넣지 않고, 블록이 끝난 뒤에만 단락 구분을 위해 빈 줄(`\\n\\n`)을 넣는다.
  ...
  public Map<String, Object> regenerateSummary(
    ...
    String userPrompt = String.format("""
        ...
        - Ordered list: 실제 순서를 반영해 `1.`, `2.`, `3.` ... 형태로 작성하며,
          각 하위 리스트는 레벨당 공백 3칸 들여쓰기로 작성한다.
        - Bold: `**굵게**` 표현 허용
        - 문단(heading/문장) 사이에는 빈 줄 한 줄(`\\n\\n`)을 넣어 구분한다.
        - 리스트 내부 항목들 사이에는 빈 줄을 넣지 않고, 블록이 끝난 뒤에만 단락 구분을 위해 빈 줄(`\\n\\n`)을 넣는다.
